...
* Построение временные рядов - нехватка информации, а также ее малое количество
* Построение модель Denoising Transformer Autoencoder для генерации эмбеддингов - недостаток оперативной памяти, а также мощностей для запуска
